    ...
    <div>
      ...
      <section className="">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-between items-center">
          <div className="py-10 pl-6 sm:pl-[50px]">
            ...
            <p className=" lg:text-[24px] max-w-[504px] mt-10 leading-[124%] pr-6 sm:pr-[50px]">
          ...
          <div className="flex flex-col md:flex-row w-full justify-between h-full bg-primary sm:pr-[50px]">
            ...
            <div className="sm:pl-[50px] overflow-hidden lg:pl-[100px] w-full py-[60px]">
      ...
      <section className="">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-between md:items-center">
          <div className="flex pl-6 sm:pl-[50px] bg-primary overflow-hidden flex-col order-2 md:order-1 md:flex-row w-full justify-between h-full">
          ...
          <div className=" pl-6 sm:pl-[50px] lg:pl-[100px] order-1 md:order-2 mt-[50px] md:mt-0">
